<template>
    <Head>
        <title>Edit Mata Pelajaran - Buweuk Sipit Academy</title>
    </Head>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card border-0 shadow">
                    <div class="card-body">
                        <h5><i class="fa fa-bookmark"></i> Edit Mapel</h5>
                        <hr />
                        <form @submit.prevent="submit">
                            ...
                            <div class="mb-4">
                                ...
                                />
                                <small class="text-muted">JPG, PNG, atau WebP. Maksimal 5 MB. Kosongkan jika tidak ingin mengganti gambar.</small>
...
export default {
    ...
    setup(props) {
        const form = reactive({
            ...
            category: props.lesson.category,
            thumbnail: null,
        });

        const thumbnailPreview = ref(props.lesson.thumbnail_url || null);
        ...
        const handleThumbnail = (event) => {
            ...
            if (!file) {
                thumbnailPreview.value = props.lesson.thumbnail_url || null;
                return;
            }
        ...
        const submit = () => {
            router.post(`/admin/lessons/${props.lesson.id}`, {
                ...form,
                _method: 'put',
            }, {
                forceFormData: true,
